...
// הגדרת הפונט עם תמיכה בעברית ובמשקלים שונים
...
export default function Home() {
  ...
  const filteredImages =
    activeCategory === "הכל" ? initialImages : initialImages.filter((image) => image.category === activeCategory);
      ...
      <section className="relative w-full px-6 md:px-24 py-16 md:py-20 bg-[#f8f8f8] text-[#331a34]">
        ...
        <div className="max-w-4xl mx-auto">
          <motion.h2
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="text-4xl md:text-5xl text-center mb-4 text-[#ffb4d8]"
          >
            העיבוד שלי
          </motion.h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Link href="/gallery/משפחה">
              ...
              >
                <div className="relative overflow-hidden rounded-lg mb-4 h-48 md:h-56">
                  ...
                  <div className="absolute inset-0 bg-[#331a34]/30 opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-in-out flex items-center justify-center">
                    <svg
                      ...
                      className="w-14 h-14 text-[#ffb4d8] transform scale-50 group-hover:scale-100 transition-transform duration-700 ease-in-out"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <h3 className="text-xl text-center text-[#5d3a59]">צילומי משפחה</h3>
              </motion.div>
            </Link>
            ...
            <Link href="/gallery/ניו בורן">
              ...
              >
                ...
                <h3 className="text-xl text-center text-[#5d3a59]">צילומי ניו בורן</h3>
              </motion.div>
            </Link>
            ...
            <Link href="/gallery/חלאקה">
              ...
              >
                ...
                <h3 className="text-xl text-center text-[#5d3a59]">צילומי חלאקה</h3>
              </motion.div>
            </Link>
            ...
            <Link href="/gallery/סמאש קייק">
              ...
              >
                ...
                <h3 className="text-xl text-center text-[#5d3a59]">צילומי סמאש קייק</h3>
              </motion.div>
            </Link>
          </div>
        </div>
